...
function NavBar() {
    ...
    return <nav className="z-100 pb-0 p-4 sticky top-0 flex justify-between flex-row gap-2 md:p-4 md:flex md:flex-col md:justify-start md:contents-stretch md:gap-2 print-hidden">
